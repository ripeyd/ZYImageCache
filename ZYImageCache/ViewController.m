...
@property (nonatomic, strong) ZYViewModel       *viewModel;
//下载队列
...
- (void)viewDidLoad {
    ...
    self.viewModel = [[ZYViewModel alloc] initWithBlock:^(id data) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ZYCollectionViewCell *cell  = [collectionView dequeueReusableCellWithReuseIdentifier:reuseID forIndexPath:indexPath];
    ZYModel *model        = self.dataArray[indexPath.row];
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[ZYCollectionViewCell class] forCellWithReuseIdentifier:reuseID];
