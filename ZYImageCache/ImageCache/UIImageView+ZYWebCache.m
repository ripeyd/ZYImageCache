...
//        NSLog(@"取消之前的下载操作 %@",title);
        ...
        [[ZYWebImageManager sharedManager] cancelDownloadImageWithUrlString:self.kc_urlString];
    }
    //新操作要开始下载 就要记录
    ...
    [[ZYWebImageManager sharedManager] downloadImageWithUrlString:urlString completeHandle:^(UIImage *downloadImage,NSString *urlString) {
        //下载完成 要制空
